...
function Hologram() {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      function updateDisplay(mode) {
        const minutes = Math.floor(
          mode === "Session" ? sessionTimeSec / 60 : breakTimeSec / 60
        );
        let seconds =
          mode === "Session" ? sessionTimeSec % 60 : breakTimeSec % 60;
      ...
      function updateTimer() {
        if (isPlaying) {
          if (sessionTimeSec > 0) {
            ...
            updateDisplay("Break");
            if (breakTimeSec === 1) {
              // Check if breakTimeSec is 00:01
              beepSound.play();
            }
            if (breakTimeSec === 2) {
              // Check if breakTimeSec is 00:02
  ...
  return (
    <div className="container">
      <div className="clock">
        <div className="clock-title" id="anchor"></div>

        <div className="main-time-container">
          <div className="t-container">
            <div className="img-time-container"></div>
            <div className="t-label" id="timer-label">
              Question
            </div>
